...
from .main import ConversionResult, get_markdown, get_markdown_directory
...
def convert(
    ...
    results = asyncio.run(_convert(inputs, output_dir, layout, max_transcriptions, whisper_model))
